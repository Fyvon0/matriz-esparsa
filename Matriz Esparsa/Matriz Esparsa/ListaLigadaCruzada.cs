...
namespace Matriz_Esparsa
{
    class ListaLigadaCruzada
    {
        ...
        //exibido em um gridview próprio.

        //Criar a estrutura básica da matriz esparsa com dimensão M x N - Construtor - feito
        public ListaLigadaCruzada(int qtdeLinhas, int qtdeColunas)
        {
            linhas = new Celula[qtdeLinhas + 1]; // A primeira linha é feita de nós cabeças, havendo l-1 linhas de dados
            colunas = new Celula[qtdeColunas + 1]; // O mesmo para as colunas
